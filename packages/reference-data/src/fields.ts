...
export const FIELDS: readonly FieldSpec[] = [
  ...
  {
    id: 'economy.budget_revenues',
    unit: 'USD',
    description: 'Central government budget revenues',
    paths: [['Economy', 'Budget', 'revenues']],
    parse: 'number',
    projection: 'nominal-usd',
    range: [1e4, 1e14],
  },
  {
    id: 'economy.budget_expenditures',
    unit: 'USD',
    description: 'Central government budget expenditures',
    paths: [['Economy', 'Budget', 'expenditures']],
    parse: 'number',
    projection: 'nominal-usd',
    range: [1e4, 1e14],
  },
  {
    id: 'economy.tax_revenue_share',
    unit: '% of GDP',
    description: 'Central government tax revenue',
    paths: [['Economy', 'Taxes and other revenues']],
    parse: 'percent',
    projection: 'carry',
    range: [0, 100],
  },
  {
    id: 'economy.household_consumption_share',
    unit: '% of GDP',
    description: 'Household consumption',
    paths: [['Economy', 'GDP - composition, by end use', 'household consumption']],
    parse: 'percent',
    projection: 'carry',
    range: [0, 200],
  },
  {
    ...
    paths: [['Economy', 'GDP - composition, by end use', 'government consumption']],
    parse: 'percent',
    projection: 'carry',
    range: [0, 100],
  },
  {
    ...
    paths: [['Economy', 'GDP - composition, by end use', 'investment in fixed capital']],
    parse: 'percent',
    projection: 'carry',
    range: [0, 100],
  },
  {
    ...
    paths: [['Economy', 'Gini Index coefficient - distribution of family income']],
    parse: 'number',
    series: true,
    projection: 'carry',
    range: [10, 80],
  ...
  {
    id: 'economy.labor_force',
    unit: 'people',
    description: 'Labor force (ages 15+, employed or seeking work)',
    paths: [['Economy', 'Labor force']],
    parse: 'headcount',
    projection: 'population',
    range: [100, 2e9],
  },
  ...
  {
    id: 'economy.current_account',
    unit: 'USD',
    description: 'Current account balance',
    paths: [['Economy', 'Current account balance']],
    parse: 'number',
    series: true,
    projection: 'carry',
    range: [-1e13, 1e13],
