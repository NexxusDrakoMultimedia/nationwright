...
The copula covers 40 variables (model v3 added government revenue and budget balance, investment and government consumption as shares of GDP, the Gini index, labour participation, and remittances, so every nation starts with a calibrated economy; the sampler keeps participation within 25–90%, revenue within 3–70% of GDP, and the budget balance within ±20% of GDP, since a few real sources are anomalous). Geography that the map itself produces (coastline, land
